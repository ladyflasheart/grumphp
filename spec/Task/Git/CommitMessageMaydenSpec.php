...
{
    protected $errorMessageStart = 'Run the following command at the repository root to edit your commit message and correct the errors below '
...
MSG;
        ...
        $result->shouldBeAnInstanceOf(TaskResultInterface::class);
        $result->isPassed()->shouldBe(false);
        $result->getMessage()->shouldBe($this->errorMessageStart . PHP_EOL . 'Subject should start with a capital letter.');
    }
